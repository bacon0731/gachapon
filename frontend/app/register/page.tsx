            ...
            <form className="space-y-4" action={handleSignup}>
              ...
              <div className="flex items-center pt-1">
                <input
                  ...
                  name="terms"
                  type="checkbox"
                  className="h-4 w-4 rounded border-neutral-300 text-primary focus:ring-primary/20 dark:border-neutral-700 dark:bg-neutral-800"
                />
                <label htmlFor="terms" className="ml-2 block text-xs text-neutral-600 dark:text-neutral-400">
                  我已閱讀並同意
