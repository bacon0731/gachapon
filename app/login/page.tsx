          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-neutral-500">或使用</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center py-2 px-4 border border-neutral-300 rounded-full shadow-sm bg-white text-sm font-medium text-neutral-700 hover:bg-neutral-50"
              >
              ...
              <button
                ...
                className="w-full inline-flex justify-center py-2 px-4 border border-neutral-300 rounded-full shadow-sm bg-white text-sm font-medium text-neutral-700 hover:bg-neutral-50"
              >
                <span className="sr-only">使用 Facebook 登入</span>
