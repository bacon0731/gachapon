        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/shop" className="text-neutral-300 hover:text-primary transition-colors">
                  商品列表
                </Link>
              </li>
              <li>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-lg font-bold mb-4">客戶服務</h3>
            <ul className="space-y-2 text-sm">
              <li>
              ...
              <li>
                <Link href="/privacy" className="text-neutral-300 hover:text-primary transition-colors">
                  隱私政策
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-neutral-300 hover:text-primary transition-colors">
                  服務條款
                </Link>
              </li>
            </ul>
